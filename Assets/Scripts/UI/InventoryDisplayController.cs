...
public class InventoryDisplayController : MonoBehaviour
{
    ...
    public List<WeaponConfig.WeaponSlotType> slotSizes;
    ...
    private string GetDefaultText(int slotNumber, WeaponConfig.WeaponSlotType size)
    {
        string sizeName = (slotSizes[slotNumber] == WeaponConfig.WeaponSlotType.Small) ? "small" : "big";
